...
class RelationNetwork(nn.Module):
    ...
    def forward(self,x):
        ...
        print("Sigmoid activation function output: ",out)
        return out
...
def main():
    ...
    for boxes in bounding_box_coordinates[0:5]:
        boundingbox_image=groundtruth_image.crop(boxes)
        boundingbox_image.show()
    ...
    sample_images=torch.stack(tuple(boundingbox_image_tensors))
    print(sample_images)
