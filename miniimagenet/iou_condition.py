...
def main():
    ...
    total_bb=0
    # read image files
    query_image_path="/content/drive/MyDrive/bb0.jpg"
    query_image_coordinates=[789,490,789+84,490+84]
    support_folder_path="/content/drive/MyDrive/support/frame3254/"
    comp_image_path="/content/drive/MyDrive/bb1.jpg"
    coordinates=[[739,302,739+34,302+81],
...
#    query_image_coordinates_int=[int(x) for x in query_image_coordinates_raw]
    ...
    bb_names=os.listdir(support_folder_path)
...
#        groundtruth_image_tensor=transform_ToTensor(groundtruth_image).to(torch.float32)
    ...
    for coordinate,bb in coordinates,bb_names:
        tensor_sequence=[]
        support_image=Image.open(support_folder_path+bb)
    ...
    # to form a 100x128 matrix for relation network
        ...
        truepositives=False
        iou=IoU(coordinate,query_image_coordinates)
        total_bb+=1
        ...
        print(str(truepositive_number)+" | "+str(truenegative_number)+" | "+str(falsepositive_number)+" | "+str(falsenegative_number))
