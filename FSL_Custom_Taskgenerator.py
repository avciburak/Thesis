...
class ClassBalancedSampler(Sampler):
    ...
    def __iter__(self):
        ...
        if self.shuffle:
            batch = [[i+self.num_inst for i in torch.randperm(self.num_inst)[:self.num_per_class]] for j in range(self.num_cl)]
        else:
            batch = [[i+self.num_inst for i in range(self.num_inst)[:self.num_per_class]] for j in range(self.num_cl)]
