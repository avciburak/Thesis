...
def main():
    ...
    if os.path.exists(str("./models/miniimagenet_feature_encoder_" + str(CLASS_NUM+2) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("./models/miniimagenet_feature_encoder_" + str(CLASS_NUM+2) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"),map_location='cuda:0'))
        print("load feature encoder success")
    
    if os.path.exists(str("./models/miniimagenet_relation_network_"+ str(CLASS_NUM+2) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_network.load_state_dict(torch.load(str("./models/miniimagenet_relation_network_"+ str(CLASS_NUM+2) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"),map_location='cuda:0'))
    ...
    for episode in range(EPISODE):
        ...
        if episode%5000 == 0:
            ...
            if test_accuracy >= last_accuracy:
                ...
                torch.save(relation_network.state_dict(),str("/content/drive/MyDrive/miniimagenet_relation_network_"+ str(CLASS_NUM+2) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
